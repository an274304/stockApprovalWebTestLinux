...
@Component({
  selector: 'app-get-completed-order-at-admin',
  standalone: true,
  imports: [CommonModule, DatePipe],
  templateUrl: './get-completed-order-at-admin.component.html',
  styleUrl: './get-completed-order-at-admin.component.css'
})
export class GetCompletedOrderAtAdminComponent {
