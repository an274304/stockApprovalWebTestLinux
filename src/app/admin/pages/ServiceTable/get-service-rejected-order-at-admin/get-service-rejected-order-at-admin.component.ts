...
@Component({
  selector: 'app-get-service-rejected-order-at-admin',
  standalone: true,
  imports: [CommonModule, DatePipe],
  templateUrl: './get-service-rejected-order-at-admin.component.html',
  styleUrl: './get-service-rejected-order-at-admin.component.css'
})
export class GetServiceRejectedOrderAtAdminComponent {
  ...
  loadRejectedTable(): void {
    this.serviceTableService.GetServiceRejectedOrderAtAdmin().subscribe({
  ...
  onClickRejectedItemByOrderNo(ServiceOrderNo: string) {
    // Clear previous content 
    this.serviceDirectorTableService.GetServiceRejectedItemByOrderNo(ServiceOrderNo).subscribe({
