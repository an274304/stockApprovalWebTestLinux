...
@Component({
  ...
  styleUrl: './rejected-service.component.css'
})
export class RejectedServiceComponent {
  ...
  loadRejectedServiceTable(): void {
    this.serviceDirectorTableService.GetServiceRejectedAtDirector().subscribe({
